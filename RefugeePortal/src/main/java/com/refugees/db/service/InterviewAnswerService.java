...
import com.refugees.db.model.InterviewAnswer;
...
public class InterviewAnswerService {
	...
	{
		return DBUtils.preparedStatementHealth(
				"select mst_answer.interview_category_id, mst_answer.interview_category_version,mst_answer.interview_id,mst_answer.answer_id, mst_interview.interview_item,mst_interview.answer_type,mst_answer.answer_item from mst_answer inner join mst_interview on mst_answer.interview_id = mst_interview.interview_id order by mst_interview.interview_category_id,mst_interview.interview_id;",
				ps -> {
				}, r -> {
					List<InterviewDisplayAnswer> list = new ArrayList<>();
					while (r.next()) {
